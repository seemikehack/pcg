      ...
      <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" id="docroot">
         ...
         <fo:page-sequence id="section_s1" format="" master-reference="s1" initial-page-number="1">
            <fo:flow flow-name="xsl-region-body">
               ...
               <fo:block color="#000000" font-family="Brush Script MT Italic" font-weight="normal" font-style="normal" font-size="65.0pt" line-height="100%" space-after="0in" text-align="center">
                  <xsl:value-of select="meet"/>
               </fo:block>
               <fo:block color="#000000" font-family="Brush Script MT Italic" font-weight="normal" font-style="normal" font-size="80.0pt" line-height="100%" space-after="0in" text-align="center">
                  <xsl:value-of select="place"/>
               </fo:block>
               <fo:block color="#000000" font-family="Brush Script MT Italic" font-weight="normal" font-style="normal" font-size="9.0pt" line-height="100%" space-after="0in" text-align="center">
                  has been awarded to
               </fo:block>
               <fo:block color="#000000" font-family="Brush Script MT Italic" font-weight="normal" font-style="normal" font-size="40.0pt" line-height="100%" space-after="0in" text-align="center">
                  <xsl:value-of select="recipient"/>
               </fo:block>
               <fo:block color="#000000" font-family="Brush Script MT Italic" font-weight="normal" font-style="normal" font-size="17.0pt" line-height="100%" space-after="0in" text-align="center">
                  in
               </fo:block>
               <fo:block color="#000000" font-family="Brush Script MT Italic" font-weight="normal" font-style="normal" font-size="50.0pt" line-height="100%" space-after="0in" text-align="center">
